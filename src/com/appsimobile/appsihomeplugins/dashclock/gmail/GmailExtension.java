 ...
 */
public class GmailExtension extends DashClockHomeExtension {
    ...
    public GmailExtension(Context context) {
        super(context);
    }
    ...
    private Set<String> getSelectedAccounts() {
        ...
        final String[] accounts = GmailExtension.getAllAccountNames(getContext());
    ...
    @Override
    public void onInitialize(FieldsBuilder dataBuilder) {
        ...
        dataBuilder.registerField(
                DASHCLOCK_EXTENSION_GMAIL,
                HomeServiceContract.FieldsResponse.DISPLAY_TYPE_DASHCLOCK,
                R.string.gmail_extension_title,
                R.drawable.ic_extension_gmail,
                new ComponentName(getContext().getPackageName(), GmailSettingsActivity.class.getName()),
                uris);
    }
