 ...
 */
public class CalendarExtension extends DashClockHomeExtension {
    ...
    public CalendarExtension(Context context) {
        super(context);
    }
    ...
    private Set<String> getSelectedCalendars() {
        ...
        if (!customVisibility || selectedCalendars == null) {
            final List<Pair<String, Boolean>> allCalendars = getAllCalendars(getContext());
    ...
    public void onInitialize(FieldsBuilder builder) {
        builder.registerField(
                DASHCLOCK_EXTENSION_CALENDAR,
                HomeServiceContract.FieldsResponse.DISPLAY_TYPE_DASHCLOCK,
                R.string.calendar_extension_title,
                R.drawable.ic_extension_calendar,
                new ComponentName(getContext().getPackageName(), CalendarSettingsActivity.class.getName()),
